#************************************************************************************************************#
#                                                                                                            #
#                 This script demonstrates how to publish a geoprocessing service using arcpy functions      #
#                                                                                                            #
...
connectionFile = os.path.join(ws, "dummy.ags")
...
try:
    ...
    if (draft_file_return['errors']):
        print("error message = " + draft_file_return['errors'])
    elif  (draft_file_return['warnings']):
        print("warning message = " + draft_file_return['warnings'])
